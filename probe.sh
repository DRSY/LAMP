...
python -W ignore -u probe.py --model_name $model_name --soft_train --soft_infer --lr $lr --seed 47 --warmup $warmup --max_epochs $max_epochs --device cuda:$device --batch_size $bs --temperature $temperature --bottom_layer_index $bli --top_layer_index $tli --init_method $init_method | tee "`date`_probe".log